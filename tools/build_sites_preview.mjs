...
const siteFiles = [
  ...
  "assets/models/dynamics-forge/forearm.stl",
  "assets/models/dynamics-forge/link.stl",
  "assets/models/dynamics-forge/MotorPropCCW.STL",
  "assets/models/dynamics-forge/MotorPropCW.STL",
